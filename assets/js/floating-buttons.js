...
document
  .getElementById("mail-anchor")
  .setAttribute(
    "href",
    "mailto:?Subject=" + titleEncoded + "&Body=" + fullUrlEncoded
  );
document
  .getElementById("fb-anchor")
  .setAttribute(
    "href",
    "https://www.facebook.com/sharer.php?u=" + fullUrlEncoded
  );
document
  .getElementById("li-anchor")
  .setAttribute(
    "href",
